      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            if(widget.curr_desig=="Professor")
            ModulesCard(cardLine: 'Research Module' ,  pageMover : '/rspc_home_page'),
            if(widget.curr_desig=="rspc_admin")
            ModulesCard(cardLine: 'Research Module' ,  pageMover : '/dean_home'),
