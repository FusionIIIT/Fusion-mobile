...
class FiledIndent extends StatefulWidget {
  @override
  _FiledIndentPageState createState() => _FiledIndentPageState();
}

class _FiledIndentPageState extends State<FiledIndent> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 80), // Adding horizontal space between buttons
              Text(
                'Status',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              SizedBox(width: 8), // Adding horizontal space between buttons
              ElevatedButton(
                onPressed: (){
