...
class RejectedRequest extends StatefulWidget {
  @override
  _RejectedRequestPageState createState() => _RejectedRequestPageState();
}

class _RejectedRequestPageState extends State<RejectedRequest> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Rejected request'), // Add your title here
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 8.0), // Adjust the spacing as needed
                child: ElevatedButton(
                  onPressed: () {
