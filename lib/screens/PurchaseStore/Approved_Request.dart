...
class ApprovedRequest extends StatefulWidget {
  @override
  _ApprovedRequestPageState createState() => _ApprovedRequestPageState();
}

class _ApprovedRequestPageState extends State<ApprovedRequest> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Approved Request'), // Add your title here
