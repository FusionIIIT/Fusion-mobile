...
class CoursesProposalupdate extends StatefulWidget {
  @override
  _CourseProposalupdate createState() => _CourseProposalupdate();
}

class _CourseProposalupdate extends State<CoursesProposalupdate> {
                        ...
                        if (_formKey.currentState?.validate() ?? false) {
                          setState(() {
                            ...
                            _showSnackbar(context,
                                'Course Proposal Updated successfully');
