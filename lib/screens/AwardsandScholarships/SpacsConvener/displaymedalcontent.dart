...
import 'dart:async';
import 'dart:convert';
class DisplayMedalContent extends StatefulWidget {
  const DisplayMedalContent({super.key});

  @override
  State<DisplayMedalContent> createState() => _DisplayMedalContentState();
}

class _DisplayMedalContentState extends State<DisplayMedalContent> {
    late Map<String, dynamic> displaySilver={};
   late Map<String, dynamic> displayGold={};
  void initState() {
    super.initState();
    getApplications();
  }
