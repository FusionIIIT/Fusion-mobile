...
class AnnouncementIns extends StatefulWidget {
  @override
  _AnnouncementState createState() => _AnnouncementState();
}

class _AnnouncementState extends State<AnnouncementIns> {
  bool _loading = true;
  late String name;
        ...
        children: [
          ...
          Card(
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  child: myContainer("Announcement 1"),
                  onTap: () {
                    Navigator.pushNamed(
                ...
                InkWell(
                  child: myContainer("Announcement 2"),
                  onTap: () {
                    Navigator.pushNamed(
                        context, '/registered_courses/course_home/module',
                        arguments: data);
                ...
                InkWell(
                  child: myContainer("Announcement 3"),
                  onTap: () {
                    Navigator.pushNamed(
                        context, '/registered_courses/course_home/module',
                        arguments: data);
