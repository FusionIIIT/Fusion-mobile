...
class ForwardCPDAAdvance extends StatefulWidget {
  ...
  @override
  State<ForwardCPDAAdvance> createState() {
    return _ForwardCPDAAdvanceState();
  }
}

class _ForwardCPDAAdvanceState extends State<ForwardCPDAAdvance> {
  // Prefilled fields
