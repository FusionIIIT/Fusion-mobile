                ...
                rows: List.generate(
                  _modifiedFeedbackDates.length,
                      (index) => DataRow(cells: [
                        ...
                        DataCell(ExpandableText(text: _modifiedFeedbackDates[index].description ?? '', maxLines: 1)),
                        DataCell(Text(_modifiedFeedbackDates[index].feedbackType)),
                        DataCell((user == 'student') ? (ExpandableText(text: _modifiedFeedbackDates[index].feedbackRemark ?? '', maxLines: 1))
                            :TextField(
