...
//A dummy list of sample json returned by backend (this declinedComplaints will bew removed when backend is available)
final List<Map<String, String>> declinedComplaints = [
  {
    "S.No": " ",
    "Date": " ",
    "Complaint Type": " ",
