                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(
                            color: Colors.deepOrange), // Bottom partition line
                      ),
                    ),
                    child: Text(
                      'Details :',
                  ...
                  SizedBox(
                      height: 10), // Added spacing between heading and columns
                  Container(
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(
                  ...
                  Row(
                    ...
                    children: [
                      Text('1'),
                      SizedBox(width: 5), // Added spacing between columns
                      Container(width: 1, color: Colors.grey), // Vertical line
                      SizedBox(width: 5), // Added spacing between columns
                      Text('Proposal 1'),
                      SizedBox(width: 5), // Added spacing between columns
                      Container(width: 1, color: Colors.grey), // Vertical line
